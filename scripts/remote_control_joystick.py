...
import pygame as pg # Joystick driver
from functools import partial # use built-in fucntions to control the robot
import hiwonder
...
class Joystick:
    ...
    def update_buttons(self):
        ...
        if chassis:
            ...
            axis[2] = hiwonder.misc.val_map(axis[2], -1, 1, 60, -60)
...
if __name__ == '__main__':
    ...
    while True:
        try:
            ...
            print('Angle rotate = %d' % hiwonder.serial_servo.read_position(1))
            print('Angle left = %d' % hiwonder.serial_servo.read_position(2))
            print('Angle rigth = %d' % hiwonder.serial_servo.read_position(3))
            js.update_buttons()
